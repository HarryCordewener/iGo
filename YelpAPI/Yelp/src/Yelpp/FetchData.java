...
public class FetchData {
	...
	public static String queryLocation(JSONObject obj) {
		...
		String USER = "root";
		String PASS = "cs441";
		String queryitem = ((JSONObject) obj.get("location")).get("city").toString();
		...
		Statement stmt = null;
			    try {
			        ...
			        String sql = "Select locationid from locations where locationname ="+"'"+queryitem+"'";
	...
	public static void addLocation(JSONObject obj) {
		...
		String PASS = "cs441";
			    ...
			    try {
			        ...
			        "VALUES ('"+location+"','"+GPS+"','"+locationtype+"','"+subtype+"','"+active+"','"+state+"')";
			        System.out.println(sql);
